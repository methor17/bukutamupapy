...
<h3><b>LISTING TAMU DARI TANGGAL: <?php echo "$dari"; ?>  SAMPAI TANGGAL :<?php echo "$sampai"; ?></b></h3>
<br><br>
...
$query = "SELECT nota, nm_tamu, instansi, nama, alasan, Jin, Jout, tgl FROM tb_buku WHERE (tgl BETWEEN '$dari' AND '$sampai')"; 
...
$pdf->WriteHTML($html);
$pdf->Output('Laporan tamu pertanggal.pdf', 'D');
?>
